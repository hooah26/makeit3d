...
if __name__ == '__main__':
    ...
    parser.add_argument('--radius_range', type=float, nargs='*', default=[0.8, 1.2],
    ...
    with torch.no_grad():
        ...
        DPT.util.io.write_depth(os.path.join(opt.workspace, opt.text.replace(" ", "_") + '_depth'),
                                depth_prediction.squeeze().cpu().numpy(), bits=2)
